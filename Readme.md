...
- Το κόκκινο σημείο δείχνει τη βέλτιστη λύση που προέκυψε από τη μέθοδο Simplex.

## **5. Συμπεράσματα**

Η μέθοδος Simplex παρείχε μια αποτελεσματική προσέγγιση για την εύρεση της βέλτιστης λύσης. Η γραφική αναπαράσταση επιβεβαιώνει ότι η λύση βρίσκεται στο όριο της εφικτής περιοχής, γεγονός που είναι αναμενόμενο για προβλήματα γραμμικού προγραμματισμού. Η μέθοδος αποδείχθηκε αποδοτική στην εύρεση της μέγιστης τιμής της αντικειμενικής συνάρτησης με βάση τους δοθέντες περιορισμούς.
